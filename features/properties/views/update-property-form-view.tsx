...
import { createProperty, updateProperty } from '@/lib/firebase-queries'
...
export default function UpdatePropertyFormView({property}: Props) {
  ...
  const onSubmit: SubmitHandler<FormValues> = (values) => {
    startTransition(async () => {
      try {
        await updateProperty<FormValues>(property._id,values)
